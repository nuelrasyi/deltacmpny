      ...
      <aside className="w-72 bg-slate-950 text-slate-300 flex flex-col hidden lg:flex flex-shrink-0 shadow-xl z-20">
        ...
        <div className="p-4 border-t border-white/10">
          ...
          <form action={logout} className="w-full">
            ...
            <button type="submit" className="flex items-center px-4 py-3 w-full text-sm font-medium rounded-xl text-rose-400 hover:bg-rose-500/10 transition-all text-left group">
