  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      ...
      <div className="flex items-center gap-4">
        <Link href="/superadmin/programs" className="p-2 hover:bg-slate-100 rounded-full transition-colors">
          <ArrowLeft className="w-5 h-5 text-slate-600" />
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Tambah Program Baru</h1>
          <p className="text-sm text-slate-500 mt-1">Buat program sertifikasi atau pelatihan baru.</p>
        </div>
      </div>
      ...
      <form action={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-3">
          <Link href="/superadmin/programs" className="px-6 py-2.5 text-sm font-medium text-slate-600 hover:bg-slate-100 rounded-xl transition-colors">
            Batal
          </Link>
          <button 
            type="submit"
          ...
          >
            {loading ? (
              ...
              <><Save className="w-4 h-4 mr-2" /> Simpan Program</>
            )}
          </button>
        </div>
      </form>
