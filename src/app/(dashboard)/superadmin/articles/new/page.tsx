          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 space-y-6">
              ...
              <div className="pt-6 border-t border-slate-100 flex flex-col gap-3">
                ...
                <Link href="/superadmin/articles" className="w-full text-center px-6 py-3 text-sm font-medium text-slate-600 hover:bg-slate-50 rounded-xl transition-colors border border-slate-200">
                  Batal
                </Link>
              </div>
