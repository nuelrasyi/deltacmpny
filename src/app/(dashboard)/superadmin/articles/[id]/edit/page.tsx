...
import { updateArticle, getArticleById } from '../../actions'
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      ...
      <div className="flex items-center gap-4">
        <Link href="/superadmin/articles" className="p-2 hover:bg-slate-100 rounded-full transition-colors">
          <ArrowLeft className="w-5 h-5 text-slate-600" />
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Edit Artikel</h1>
          <p className="text-sm text-slate-500 mt-1">Ubah konten atau gambar sampul artikel Anda.</p>
        </div>
      </div>
      ...
      <form action={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-8 space-y-8">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mb-3">Sampul Artikel</label>
            {selectedMedia ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              ...
              <input 
                ...
                placeholder="Misal: Pentingnya Sertifikasi Ahli K3 Umum"
              />
            </div>
            ...
            <div className="md:col-span-2 flex items-center gap-3 p-4 bg-slate-50 rounded-xl border border-slate-200">
              <input 
                ...
                name="is_published" 
                value="true"
                defaultChecked={!!article?.published_at}
        ...
        <div className="flex justify-end gap-3">
          <Link href="/superadmin/articles" className="px-6 py-2.5 text-sm font-medium text-slate-600 hover:bg-slate-100 rounded-xl transition-colors">
            Batal
          </Link>
          <button 
            type="submit"
